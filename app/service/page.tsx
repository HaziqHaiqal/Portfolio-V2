  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div className="relative bg-gray-50 dark:bg-gray-800">
        ...
        <main className="relative z-10 px-4 pb-28 pt-16 sm:px-6 md:pt-24">
          <div className="mx-auto max-w-6xl">
            <Reveal y={16} duration={0.5}>
              <Link
                href="/"
                className="group mb-16 inline-flex min-h-11 items-center gap-2.5 py-2 font-mono text-base text-gray-500 transition-colors hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100"
              >
